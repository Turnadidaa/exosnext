...
// Add sound toggle button to the game
function addSoundToggle() {
    ...
    soundButton.onclick = () => {
        ...
        soundButton.classList.toggle('sound-enabled', isEnabled);
    };
    soundButton.classList.add('sound-enabled');
    document.body.appendChild(soundButton);
}

// Initialize sound toggle button when the page loads
